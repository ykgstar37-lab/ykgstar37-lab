...
<table>
  <tr>
    <td width="50%">
      <h3 align="center">CryptoVol Dashboard</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Personal-3B82F6?style=flat-square"/>
      </p>
      <p align="center">
        <a href="https://github.com/ykgstar37-lab/crypto-volatility-intelligence-system">
          <img src="https://img.shields.io/badge/REPO-181717?style=for-the-badge&logo=github&logoColor=white"/>
        </a>
      </p>
      <p>
        <b>실시간 멀티코인 변동성 예측 대시보드</b><br/>
        5개 GARCH 모형으로 BTC/ETH/SOL 변동성을 예측하고 매매 시그널을 생성합니다. Binance WebSocket 실시간 가격, Monte Carlo 포트폴리오 시뮬레이터, 예측 정확도 트래커, 백테스트, GPT-4o-mini AI 시장 브리핑을 포함합니다.
      </p>
      <p>
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white"/>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black"/>
        <img src="https://img.shields.io/badge/WebSocket-010101?style=flat-square&logo=socketdotio&logoColor=white"/>
        <img src="https://img.shields.io/badge/GARCH-blue?style=flat-square"/>
        <img src="https://img.shields.io/badge/Monte_Carlo-purple?style=flat-square"/>
      </p>
    </td>
    <td width="50%">
      <h3 align="center">PyMate</h3>
      <p align="center">
      ...
      <p>
        <b>AI 기반 학습 플랫폼</b><br/>
        LangGraph 워크플로우 기반 대화형 학습 챗봇. OX 퀴즈, AI 코드 리뷰, 7가지 학습 도구(요약, 단계별 설명, 플래시카드, 퀴즈, 비교표, 예제, 노트)를 제공합니다.
      </p>
      <p>
        <img src="https://img.shields.io/badge/Django-092E20?style=flat-square&logo=django&logoColor=white"/>
        <img src="https://img.shields.io/badge/LangChain-1C3C3C?style=flat-square&logo=langchain&logoColor=white"/>
  ...
  <tr>
    <td width="50%">
      <h3 align="center">Seoul Culture Map</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Personal-3B82F6?style=flat-square"/>
      </p>
      <p align="center">
      ...
      <p>
        <b>서울 문화시설 인터랙티브 탐색 맵</b><br/>
        서울시 2,500+ 문화시설을 Leaflet 지도에 시각화합니다. K-means 군집분석, 권역별 분류, 카테고리 밀도 히트맵, 지하철 접근성 분석, AI 관광 코스 추천을 제공합니다.
      </p>
      <p>
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white"/>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black"/>
    ...
    <td width="50%">
      <h3 align="center">WorkFlow Agent</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Team-F59E0B?style=flat-square"/>
      </p>
      <p align="center">
        <a href="https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN21-FINAL-3TEAM">
          <img src="https://img.shields.io/badge/REPO-181717?style=for-the-badge&logo=github&logoColor=white"/>
        </a>
      </p>
      <p>
  ...
  <tr>
    <td width="50%">
      <h3 align="center">SubFlow</h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Team-F59E0B?style=flat-square"/>
      </p>
      <p align="center">
        <a href="https://github.com/hyebinhy/SubFlow">
          <img src="https://img.shields.io/badge/REPO-181717?style=for-the-badge&logo=github&logoColor=white"/>
        </a>
      </p>
      <p>
        <b>구독 서비스 통합 관리 플랫폼</b><br/>
        Netflix, Spotify 등 30개 이상의 구독 서비스를 한곳에서 관리합니다. 월별 지출 추이 분석, 카테고리별 비중 차트, 결제일 캘린더, 환율 변동 알림, 중복 구독 감지, 절약 제안, 가격 변동 알림, 무료 체험 만료 추적 기능을 제공합니다. 
      </p>
      <p>
        <img src="https://img.shields.io/badge/FastAPI-009688?style=flat-square&logo=fastapi&logoColor=white"/>
        <img src="https://img.shields.io/badge/React-61DAFB?style=flat-square&logo=react&logoColor=black"/>
